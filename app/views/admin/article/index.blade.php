        ...
        <section class="panel">
            <header class="panel-heading">
                ...
                <span class="tools pull-right">
                    ...
                    <a href="javascript:void(0)" onClick="onDelAll(&#39;{{URL::to('/').'/admin/articles/destroyMany/'}}&#39;)"><i class="fa fa-times-circle fa-lg"></i>Xóa {{$resourceName}}</a>
                 </span>
            </header>
                    ...
                    <table id="dataTable" class="display table table-bordered table-striped dataTable" cellpadding="0" cellspacing="0">
                        <thead>
                            <tr>
                                ...
                                <th style="width: 120px">Ngày viết</th>
                                <th>Kích hoạt</th>
                                <th>Sửa/Xóa</th>
                            </tr>
                        </thead>
...
<script>
    $(document).ready(function() {
        $('#dataTable').dataTable( {
            "processing": false,
            "serverSide": true,
            "ajax": "{{URL::to('/admin/articles/loadDatatable')}}",
            "order": [[ 2, "desc" ]],
            "columnDefs": [
                {
                    ...
                    "render": function ( data, type, row ) {
                        ...
                        var html = '<label id="active' + row[2] + '"><a href="javascript:void(0)" onclick="changeValueCol(' + row[2] + ', &#39;active&#39;, ' + '&#39;articles&#39;, ' + data + ', &#39;id&#39;' + ')">' + icon + '</a></label>';
                        return  html;
                    },
                    "targets": 7
                },
                {
                    ...
                    // this case `data: 0`.
                    "render": function ( data, type, row ) {
                        var url_edit = "{{URL::to('/admin/articles')}}" + '/' + row[2] + '/' + 'edit';
                        var url_del  = "{{ URL::to('/admin/articles')}}" + '/' + row[2];
