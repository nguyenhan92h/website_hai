                            ...
                            <div class="form">
                                ...
                                <input type="hidden" name="_method" value="PUT">
                                    ...
                                    <div class="form-group ">
                                        ...
                                        <div class="col-lg-10">
                                            {{ Form::select('category', $categoryLists, $data->category_id, array('class' => 'form-control')) }}
                                    ...
                                    <div class="form-group ">
                                        ...
                                        <div class="col-lg-10">
                                            <textarea name="content_short" id="content_short" rows="5" class="form-control">
                                                {{ Input::old('content_short', $data->content_short) }}
                                            </textarea>
                                    ...
                                    <div class="form-group ">
                                        ...
                                        <div class="col-lg-10">
                                            <input class=" form-control" value="{{ Input::old('meta_title', $data->meta_title) }}" id="meta_title" name="meta_title" type="text">
                                    ...
                                    <div class="form-group ">
                                        ...
                                        <div class="col-lg-10">
                                            <input class=" form-control" id="meta_description" name="meta_description" value="{{ Input::old('meta_description', $data->meta_description) }}" type="text">
                                    ...
                                    <div class="form-group last">
                                        ...
                                        <div class="col-md-10">
                                            <div data-provides="fileupload" class="fileupload fileupload-new">
                                                ...
                                                {{HTML::image('public/uploads/articles/'.$data->image)}}
                                                </div>
