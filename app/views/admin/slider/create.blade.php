                        ...
                        <div class="panel-body">
                            <div class="form">
                                {{Form::open(array("url" => route($resource.'.store'), 'files'=>true, 'class' => 'cmxform form-horizontal adminex-form', 'method' => 'post'))}}
                                    ...
                                    <div class="form-group ">
                                        <label for="content" class="control-label col-lg-2 col-sm-3">Nội dung</label>
                                    ...
                                    <div class="form-group ">
                                        ...
                                        <div class="col-lg-10">
                                            <input class=" form-control" id="link" name="link" type="text" value="{{Input::old('link')}}">
                                            {{ $errors->first('link', '<span style="color:#c7254e;margin:0 1em;">:message</span>') }}
                                        </div>
                                    </div>
                                    <div class="form-group last">
                                        <label class="control-label col-lg-2">Ảnh Slider</label>
                                        <div class="col-md-10">
