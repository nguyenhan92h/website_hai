        ...
        <section class="panel">
            <header class="panel-heading">
                ...
                <span class="tools pull-right">
                    ...
                    <a href="javascript:void(0)" onClick="onDelAll(&#39;{{URL::to('/').'/admin/slider/destroyMany/'}}&#39;)"><i class="fa fa-times-circle fa-lg"></i>Xóa {{$resourceName}}</a>
                 </span>
            </header>
...
<script>
    $(document).ready(function() {
        $('#dataTable').dataTable( {
            "processing": false,
            "serverSide": true,
            "ajax": "{{URL::to('/admin/slider/loadDatatable')}}",
            "order": [[ 2, "desc" ]],
            "columnDefs": [
                {
                    ...
                    "render": function ( data, type, row ) {
                        var link_img = "{{URL::to('/uploads/slider/')}}/";
                        var html = '<img style="width:180px" src="' + link_img + data + '" alt="img">';
                        return  html;
                    },
                    "targets": 6
                },
                {
                    ...
                    "render": function ( data, type, row ) {
                        ...
                        var html = '<label id="active' + row[2] + '"><a href="javascript:void(0)" onclick="changeValueCol(' + row[2] + ', &#39;active&#39;, ' + '&#39;slider&#39;, ' + data + ', &#39;id&#39;' + ')">' + icon + '</a></label>';
                        return  html;
                    },
                    "targets": 8
                },
                {
                    ...
                    // this case `data: 0`.
                    "render": function ( data, type, row ) {
                        var url_edit = "{{URL::to('/admin/slider')}}" + '/' + row[2] + '/' + 'edit';
                        var url_del  = "{{ URL::to('/admin/slider')}}" + '/' + row[2];
