                            ...
                            <div class="form">
                                {{Form::open(array("url" => route($resource.'.store'), 'class' => 'cmxform form-horizontal adminex-form', 'method' => 'post'))}}
                                    ...
                                    <div class="form-group ">
                                        ...
                                        <div class="col-lg-10">
                                            <textarea name="content" id="content" class="form-control" rows="10">{{Input::old('content')}}</textarea>
                                        ...
                                        <div class="col-lg-10">
                                            <div id="spinner1">
                                                <div class="input-group input-small">
                                                    <input type="text" readonly="" value="{{Input::old('order')}}" name="order" class="spinner-input form-control">
